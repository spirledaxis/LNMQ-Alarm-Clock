...
class TMP117:
    ...
    **Quickstart: Importing and using the device**
    ...
    def __init__(self, i2c, address=0x48) -> None:
        ...
        # conversion, including averaging, is complete. So we sleep for that
        # amount of time
        time.sleep(
    ...
    def alert_status(self) -> AlertStatus:
        ...
        return AlertStatus(high_alert=self._high_alert,
    ...
    def averaging_measurements(self, value: int) -> None:
        if value not in averaging_measurements_values:
            raise ValueError(
                "Value must be a valid averaging_measurements setting")
