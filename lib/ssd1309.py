...
class Display(object):
    ...
    def __init__(self, spi=None, cs=None, dc=None, rst=None,
                 i2c=None, address=0x3C, width=128, height=64, flip=False, offscreen_warnings=True):
        ...
        self.offscreen_warnings = offscreen_warnings
        # Buffer
    ...
    def set_contrast(self, value):
        ...
        self.write_cmd(0x81)              # Set Contrast Control command
        self.write_cmd(value)             # Contrast level
